...
# ☀️ Solar Production Forecasting - Nouvelle-Aquitaine
...
## PROJECT SLIDES
* [See the Project Slides](slides)

## Execution
You can execute this model directly from Colab:
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](definitive_productions.ipynb)

## Desafíos Superados
1. **Data Leakage:** Eliminación de variables futuras para un modelo Day-Ahead.
2. **Model Bias:** Superamos la regresión a la media del Random Forest mediante XGBoost.
3. **Robustez:** nMAE diurno en un **4.62%**.
